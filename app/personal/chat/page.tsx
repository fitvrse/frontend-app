  ...
  const contacts = [
    {
      ...
      lastMessage: "Vou tentar fazer o treino hoje à noite",
      time: "10:30",
      unread: 0,
      online: true,
    },
    {
      ...
      name: "Mariana Costa",
      avatar: "/placeholder.svg?height=40&width=40",
      lastMessage: "Obrigada pelo treino de hoje!",
      time: "09:15",
      unread: 2,
      online: false,
    },
  ...
  const messages = [
    {
      id: 1,
      sender: "me",
      content: "Bom dia, Carlos! Como está se sentindo após o treino de ontem?",
      time: "09:30",
    },
    {
      id: 2,
      sender: "other",
      content: "Bom dia, João! Estou me sentindo bem, apenas com uma leve dor nas pernas.",
      time: "09:45",
    },
    {
      id: 3,
      sender: "me",
      content:
        "Isso é normal após o treino que fizemos. Lembre-se de fazer os alongamentos que te ensinei e beber bastante água.",
      time: "09:47",
    },
    {
      id: 4,
      sender: "other",
      content: "Vou fazer isso! Vou tentar fazer o treino hoje à noite também.",
      time: "10:30",
    },
  ]
    ...
    <div className="p-6 h-[calc(100vh-4rem)]">
      <div className="flex flex-col h-full">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Converse com seus alunos e acompanhe seu progresso</p>
        </div>
